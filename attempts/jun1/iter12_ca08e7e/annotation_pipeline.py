...
every framing, extra sentences are NOT penalized):
  ...
  - COMPARISON-FREE DUPLICATE: the reference annotations sometimes state an
    association WITHOUT an "as compared to ..." clause (e.g. "Genotype TT is
    associated with decreased response to sitagliptin in people with Diabetes
    Mellitus, Type 2."). So for EACH sentence that ends in an "as compared to
    <baseline>" clause, ALSO emit the same sentence with that clause REMOVED.
