...
every framing, extra sentences are NOT penalized):
  ...
  - COMBINED RISK-GROUP DECOMPOSITION: when a paper lumps several individually
    rare alleles/variants into ONE risk group (e.g. "carriers of B07 risk alleles
    *35:05 + *51:01 + *67:01 ..."), the reference annotations record a SEPARATE
    per-allele sentence for EACH member. So ALSO emit, for every member allele, an
    individual sentence attributing the group's association to that allele alone
    (e.g. "HLA-B *67:01 is associated with ..."), not only the combined-group form.
  - SEVERE CUTANEOUS / HYPERSENSITIVITY phenotypes: for drug-induced skin/
    hypersensitivity reactions, also phrase the outcome using the standard reaction
    family -- "Stevens-Johnson Syndrome", "Toxic Epidermal Necrolysis" (a.k.a.
    "Epidermal Necrolysis, Toxic"), "Drug Reaction with Eosinophilia and Systemic
    Symptoms", "Severe Cutaneous Adverse Reactions", "Drug Hypersensitivity",
    "Maculopapular Exanthema" -- both individually and as a combined list, in
    addition to the paper's own wording.
