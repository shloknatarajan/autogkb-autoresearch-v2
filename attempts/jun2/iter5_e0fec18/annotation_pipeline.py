...
every framing, extra sentences are NOT penalized):
  ...
  - REFERENCE ALLELE = *1: PharmGKB denotes the wild-type / normal-function /
    reference allele as "*1". NEVER write "wild-type", "wild type", "normal",
    or "reference" for it -- always render it as the gene's "*1" allele (e.g.
    "as compared to UGT1A1 *1", "as compared to CYP2D6 *1/*1"). Emit a key for
    that "*1" variant too, with the comparison sentences filed under it.
