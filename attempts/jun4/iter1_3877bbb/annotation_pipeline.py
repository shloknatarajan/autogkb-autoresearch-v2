...
standardized PharmGKB association sentences that assert an association ABOUT that
variant:
  ...
  - Values: a list of standardized association sentences for that variant -- one
    ...
    genotype/allele it is about. Each sentence states the variant/genotype,
    polarity ("is" / "is not associated"), direction ("increased" / "decreased"),
    the phenotype or outcome, the drug (when relevant), and the comparison
    group/allele when stated. Example style:
